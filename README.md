...
> *如果你在这里看到一个不再维护或者不合适的项目，请提交一个 Pull Request 进行优化，谢谢！*
...
- [Awesome Go](#awesome-go)
    ...
    - [动态 DNS](#dynamic-dns)
    - [邮件](#email)
    - [嵌入脚本语言](#embeddable-scripting-languages)
    - [错误处理](#error-handling)
    - [文件处理](#file-handling)
    - [金融&财务](#financial)
    - [表单](#forms)
    ...
    - [代码生成和泛型](#generation-and-generics)
    - [地理位置](#geographic)
    - [Go 编译器](#go-compilers)
    - [协程](#goroutines)
    - [GUI](#gui)
    ...
    - [Web 框架](#web-frameworks)
        - [中间件](#middlewares)
            - [常用中间件](#actual-middlewares)
            - [创建 HTTP 中间件的库](#libraries-for-creating-http-middlewares)
        - [路由器](#routers)
...
- [工具集](#tools)
    ...
    - [Go 代码生成工具](#go-generate-tools)
    - [Go 工具](#go-tools)
    - [软件包](#software-packages)
        - [DevOps 工具集](#devops-tools)
        - [其他软件](#other-software)
...
* [go-sox](https://github.com/krig/go-sox) - 在 Go 中使用 libsox
* [GoAudio](https://github.com/DylanMeeus/GoAudio) - 原生 Go 音频处理库
* [gosamplerate](https://github.com/dh1tw/gosamplerate) - 在 Go 中使用 libsamplerate
* [id3v2](https://github.com/bogem/id3v2) - Go ID3 编解码库
* [malgo](https://github.com/gen2brain/malgo) - 在 Go 中使用 MiniAudio 库
* [minimp3](https://github.com/tosone/minimp3) - 轻量级 MP3 解码器库
* [mix](https://github.com/go-mix/mix) - 用于音乐应用的、基于时序的 Go 原生音频混音器
* [mp3](https://github.com/tcolgate/mp3) - 原生 Go MP3 解码器
* [music-theory](https://github.com/go-music-theory/music-theory) - Go 语言音乐理论模型
* [Oto](https://github.com/hajimehoshi/oto) - 一个在多平台上播放声音的低级库
* [PortAudio](https://github.com/gordonklaus/portaudio) - 在 Go 中使用 PortAudio 音频 I/O 库
* [portmidi](https://github.com/rakyll/portmidi) - 在 Go 中使用 PortMidi
* [vorbis](https://github.com/mccoyst/vorbis) - 原生 Go Vorbis 解码器（使用 CGO，但是没有依赖）
* [waveform](https://github.com/mdlayher/waveform) - 能够从音频流中生成波形图的 Go 扩展包

## 认证和 OAuth

*实现认证方案的库*

* [authboss](https://github.com/volatiletech/authboss) - Web 模块化认证系统（这是一个适用于 Go Web 项目的用户认证解决方案，每次启动一个新的 Go Web 项目时，你只需要安装这个库并进行配置，就可以为该项目提供认证功能了，而不需要每次自己手动去实现）
* [branca](https://github.com/hako/branca) - 在 Golang 中实现的 Branca Tokens
* [casbin](https://github.com/hsluoyz/casbin) - 支持访问控制模型（例如 ACL、RBAC、ABAC）的认证库
* [cookiestxt](https://github.com/mengzhuo/cookiestxt) - cookies.txt 文件格式解析器
* [go-email-normalizer](https://github.com/dimuska139/go-email-normalizer) - 用于提供 Email 地址规范表示的 Golang 库
* [go-guardian](https://github.com/shaj13/go-guardian) - Go-Guardian 库提供了简单、干净、惯用的方法来构建强大的现代 API 和 Web 认证，支持 LDAP、Basic、Bearer Token 和基于证书的认证
* [go-jose](https://github.com/square/go-jose) - 完整地实现了 JOSE 工作组的JSON Web Token、JSON Web Signatures 和 JSON Web Encryption 规范
* [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) - 独立的、符合规范的、用 Golang 实现的 OAuth2 服务器
* [gologin](https://github.com/dghubble/gologin) - 通过 OAuth1 和 OAuth2 认证提供者进行登录认证的链式处理器
* [gorbac](https://github.com/mikespook/gorbac) - 基于 Golang 的轻量级 RBAC 实现
* [goth](https://github.com/markbates/goth) - 提供了简单、干净、惯用的方式使用 OAuth 和 OAuth2，开箱支持处理多个提供者
* [httpauth](https://github.com/goji/httpauth) - HTTP Basic Authentication 中间件
* [jeff](https://github.com/abraithwaite/jeff) - 通过可插拔的后端实现简单、灵活、安全、惯用的 Web 会话（Session）管理
* [jwt](https://github.com/robbert229/jwt) - 干净且易于上手的 JWT（JSON Web Tokens）实现
* [jwt](https://github.com/pascaldekloe/jwt) - 轻量级 JSON Web Token (JWT) 库
* [jwt](https://github.com/cristalhq/jwt) - 安全、简单、快速的 JSON Web Tokens 实现
* [jwt-auth](https://github.com/adam-hanna/jwt-auth) - 适用于 Golang HTTP 服务器的 JWT 中间件，支持多个配置项
* [jwt-go](https://github.com/dgrijalva/jwt-go) - Golang 版 JSON Web Tokens (JWT) 实现
* [loginsrv](https://github.com/tarent/loginsrv) - 使用可插拔的后端通过 JWT 登录微服务（支持 OAuth2 (Github)、htpasswd、osiam）
* [oauth2](https://github.com/golang/oauth2) - goauth2 的继承者，通用 OAuth 2.0 包，自带 JWT、Google APIs、计算引擎和 App Engine 支持
* [osin](https://github.com/openshift/osin) - Golang OAuth2 服务器库
* [otpgo](https://github.com/jltorresm/otpgo) - Golang 版 Time-Based One-Time Password (TOTP) 和 HMAC-Based One-Time Password (HOTP) 库
* [paseto](https://github.com/o1egl/paseto) - Golang 版 Platform-Agnostic Security Tokens (PASETO)
* [permissions2](https://github.com/xyproto/permissions2) - 追踪用户、登录状态和权限的库，使用安全的 cookies 和 bcrypt
* [rbac](https://github.com/zpatrick/rbac) - 适用于 Go 应用的最小化 RBAC 包
* [scope](https://github.com/SonicRoshan/scope) - 在 Go 中轻松管理 OAuth2 作用域
* [scs](https://github.com/alexedwards/scs) - HTTP 服务器 Session 管理器
* [securecookie](https://github.com/chmike/securecookie) - 高效安全的 cookie 编码/解码
* [session](https://github.com/icza/session) - Go Web 服务器 Session 管理
* [sessiongate-go](https://github.com/f0rmiga/sessiongate-go) - 基于 SessionGate Redis 模块的 Go Session 管理
* [sessions](https://github.com/adam-hanna/sessions) - 为 Go HTTP 服务器提供简单、高性能、高度可定制的会话服务
* [sessionup](https://github.com/swithek/sessionup) - 简单高效的 HTTP Session 管理和识别包
